...
\begin{itemize}
    \item designed and implemented scalable graph-theoretic algorithms to pinpoint build-breaking commits
\end{itemize}

\divider

\cvevent{IOT Engineering Intern}{Level Home Inc.}{May 2019 -- Jan 2020}{Redwood City, CA}
\begin{itemize}
