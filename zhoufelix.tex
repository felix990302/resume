...
\cvevent{IOT Developer Intern}{California Things}{May 2019 -- Present}{Redwood City, CA}
\begin{itemize}
    \item Implemented a read-write lock for \textbf{mongodb} using an asynchronous client-server architecture in both \textbf{Swift} and \textbf{C} with a \textbf{Python} interface
\end{itemize}
