...
\begin{itemize}
    ...
    \item Lead the implementation of a \textbf{MongoDB} network semaphore using asynchronous networking in both \textbf{Swift} and \textbf{C} to prevent data races
...
for outstanding academic record and research aptitude
